...
class ListTransferTaskPage extends StatefulWidget {
  ...
  @override
  State<ListTransferTaskPage> createState() => _ListTransferTaskPageState();
}

class _ListTransferTaskPageState extends State<ListTransferTaskPage> {
  ListTransferTaskPageBloc listTransferTaskPageBloc =
  ...
  void initState() {
    ...
    listTransferTaskPageBloc
        .add(GetListTransferTaskEvent(maCV: widget.congViec.maCV));
    super.initState();
  }
